...
type ControlCommand struct {
	...
	//	*ControlCommand_Init
	//	*ControlCommand_Work
	Payload isControlCommand_Payload `protobuf_oneof:"payload"`
}
...
func (m *ControlCommand) GetPayload() isControlCommand_Payload {
	if m != nil {
		return m.Payload
	}
	return nil
...
func (x *ControlCommand) GetInit() *InitPayload {
	if x, ok := x.GetPayload().(*ControlCommand_Init); ok {
		return x.Init
	}
	return nil
}

func (x *ControlCommand) GetWork() *WorkPayload {
	if x, ok := x.GetPayload().(*ControlCommand_Work); ok {
		return x.Work
	}
	return nil
}

type isControlCommand_Payload interface {
	isControlCommand_Payload()
}

type ControlCommand_Init struct {
	Init *InitPayload `protobuf:"bytes,1,opt,name=init,proto3,oneof"`
}

type ControlCommand_Work struct {
	Work *WorkPayload `protobuf:"bytes,2,opt,name=work,proto3,oneof"`
}

func (*ControlCommand_Init) isControlCommand_Payload() {}

func (*ControlCommand_Work) isControlCommand_Payload() {}
...
type Tunnel_Udp struct {
	Udp *UDPConfig `protobuf:"bytes,5,opt,name=udp,proto3,oneof"`
}
...
var file_proto_message_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x74, 0x74, 0x70, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x2e, 0x48, 0x54, 0x54, 0x50, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x00,
	0x52, 0x04, 0x68, 0x74, 0x74, 0x70, 0x12, 0x26, 0x0a, 0x03, 0x75, 0x64, 0x70, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x55, 0x44,
	0x50, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x00, 0x52, 0x03, 0x75, 0x64, 0x70, 0x42, 0x08,
	0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x8e, 0x01, 0x0a, 0x0a, 0x48, 0x54, 0x54,
	0x50, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69,
	...
	,
...
var file_proto_message_proto_goTypes = []any{
	(TrafficToServer_Action)(0), // 0: message.TrafficToServer.Action
	(*ControlCommand)(nil),      // 1: message.ControlCommand
	(*InitPayload)(nil),         // 2: message.InitPayload
	(*WorkPayload)(nil),         // 3: message.WorkPayload
	(*TrafficToServer)(nil),     // 4: message.TrafficToServer
	(*TrafficToClient)(nil),     // 5: message.TrafficToClient
	(*RegisterReq)(nil),         // 6: message.RegisterReq
	(*Tunnel)(nil),              // 7: message.Tunnel
	(*HTTPConfig)(nil),          // 8: message.HTTPConfig
	(*TCPConfig)(nil),           // 9: message.TCPConfig
	(*UDPConfig)(nil),           // 10: message.UDPConfig
}
var file_proto_message_proto_depIdxs = []int32{
	2,  // 0: message.ControlCommand.init:type_name -> message.InitPayload
	3,  // 1: message.ControlCommand.work:type_name -> message.WorkPayload
	0,  // 2: message.TrafficToServer.action:type_name -> message.TrafficToServer.Action
	7,  // 3: message.RegisterReq.tunnel:type_name -> message.Tunnel
	9,  // 4: message.Tunnel.tcp:type_name -> message.TCPConfig
	8,  // 5: message.Tunnel.http:type_name -> message.HTTPConfig
	10, // 6: message.Tunnel.udp:type_name -> message.UDPConfig
	6,  // 7: message.TunnelService.Register:input_type -> message.RegisterReq
	4,  // 8: message.TunnelService.Data:input_type -> message.TrafficToServer
	1,  // 9: message.TunnelService.Register:output_type -> message.ControlCommand
	5,  // 10: message.TunnelService.Data:output_type -> message.TrafficToClient
...
func file_proto_message_proto_init() {
	...
	file_proto_message_proto_msgTypes[0].OneofWrappers = []any{
		(*ControlCommand_Init)(nil),
		(*ControlCommand_Work)(nil),
	}
